...
<main>
    ...
    <div class="popular-course section-padding30">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="browse-btn2 text-center mt-50">
                        <a href="{{ route('frontend.courses') }}" class="btn">Find More Courses</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="team-area pb-160 section-bg" data-background="assets/img/gallery/section_bg02.png">
        <div class="container">
            <div class="row justify-content-sm-center">
                <div class="cl-xl-7 col-lg-8 col-md-10">
                    <div class="section-tittle text-center mb-70">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="browse-btn2 text-center mt-70">
                        <a href="{{ route('frontend.teachers') }}" class="btn white-btn">View All Faculty</a>
                    </div>
                </div>
            </div>
        </div>
