        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="d-flex align-items-start align-items-sm-center gap-4">
                    <img src="{{ auth()->guard('student')->user()->profile ? auth()->guard('student')->user()->profile : env('DICEBEAR'). auth()->guard('student')->user()->name }}"
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" id="email" name="email"
                                value="{{auth()->guard('student')->user()->email }}" placeholder="john.doe@example.com">
                        </div>
                        <div class="mb-3 col-md-6">
