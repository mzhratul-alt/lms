        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="d-flex align-items-start align-items-sm-center gap-4">
                    <img src="{{ auth()->guard('admin')->user()->profile_picture ? auth()->user()->profile_picture : env('DICEBEAR_LINK'). auth()->guard('admin')->user()->first_name }}"
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" id="firstName" name="firstName"
                                value="{{auth()->guard('admin')->user()->first_name }}" autofocus="">
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="lastName" class="form-label">Last Name</label>
                            <input class="form-control" type="text" name="lastName" id="lastName" value="{{auth()->guard('admin')->user()->last_name }}">
                        </div>
                        <div class="mb-3 col-md-6">
