...
@section('page_title', 'Add New Voter')
        ...
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Add New Voter</h5> <small class="text-muted float-end">Default label</small>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.voter.store') }}" method="POST" class="row">
                        <div class="mb-3">
